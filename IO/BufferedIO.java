...
public class BufferedIO {
    ...
    public static File createFile(String fileName) {
        File file = new File("C:\\UniquePojectFolder\\UniqueProject\\src\\IO\\files\\" + fileName);
        return file;
    }
    ...
    public static void bufferedIO() throws IOException {
        BufferedWriter bw1 = new BufferedWriter(new FileWriter(createFile("1_file.txt")));
        ...
        bw1.close();
        BufferedReader br = new BufferedReader(new FileReader(createFile("1_file.txt")));
        int count = 0;
        while (br.ready()) {
